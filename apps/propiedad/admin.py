...
class PropiedadAdmin(admin.ModelAdmin):
    list_display = ('titulo','foto','direccion', 'localidad', 'tipo_propiedad','tipo_operacion', 'precio', 'moneda', 'ambientes', 'metros_cuadrados', 'fecha_creacion', 'fecha_actualizacion')
